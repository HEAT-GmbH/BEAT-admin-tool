...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "border-input bg-white dark:bg-input/30 has-[[data-slot=input-group-control]:focus-visible]:border-(--stroke--strong-950)",
        "has-[[data-slot=input-group-control]:focus-visible]:ring-ring/16 has-[[data-slot][aria-invalid=true]]:ring-destructive/20",
        "has-[[data-slot][aria-invalid=true]]:border-destructive dark:has-[[data-slot][aria-invalid=true]]:ring-destructive/40",
        "has-disabled:bg-(--bg--weak-50) dark:has-disabled:bg-input/80 h-8 rounded-lg border transition-colors",
        ...
        "has-[>[data-align=inline-start]]:[&>input]:pl-1.5 group/input-group relative flex w-full min-w-0",
        "items-center outline-none has-[>textarea]:h-auto has-disabled:text-muted-foreground",
        className,
      )}
      {...props}
    />
