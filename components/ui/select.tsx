  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 gap-1.5 rounded-lg border bg-transparent",
        "py-2 pr-2 pl-2.5 text-sm transition-colors select-none focus-visible:ring-3 aria-invalid:ring-3 data-[size=default]:h-8",
        "data-[size=sm]:h-7 data-[size=sm]:rounded-[min(var(--radius-md),10px)] *:data-[slot=select-value]:gap-1.5",
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        >
          ...
          <SelectPrimitive.List className="grid grid-cols-1 gap-1">
            {children}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground gap-2",
        "rounded-[0.5rem] py-1 pr-8 pl-1.5 text-sm [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center",
        "*:[span]:last:gap-2 relative flex w-full cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none",
        "data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        "py-2 pl-2 data-[selected]:bg-accent group",
        className,
      )}
      {...props}
    >
